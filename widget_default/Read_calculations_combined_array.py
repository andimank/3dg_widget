...
import numpy as np
import pandas as pd
from configurations import system_strs
...
obsfile_list = {
    ...
    "v22_eta_cen_20_70_STAR"         : ['v22______diff_eta__20_70_STAR___AuAu__weight', None, None],
    ...
    #
    "v22_pt_cen_00_05_STAR"          : ['v22______diff_pt___00_05_STAR___AuAu________', None, None],
    "v22_pt_cen_05_10_STAR"          : ['v22______diff_pt___05_10_STAR___AuAu________', None, None],
    "v22_pt_cen_10_20_STAR"          : ['v22______diff_pt___10_20_STAR___AuAu________', None, None],
    "v22_pt_cen_20_30_STAR"          : ['v22______diff_pt___20_30_STAR___AuAu________', None, None],
    "v22_pt_cen_30_40_STAR"          : ['v22______diff_pt___30_40_STAR___AuAu________', None, None],
    "v22_pt_cen_40_50_STAR"          : ['v22______diff_pt___40_50_STAR___AuAu________', None, None],
    "v22_pt_cen_50_60_STAR"          : ['v22______diff_pt___50_60_STAR___AuAu________', None, None],


    'v22_eta_cen_00_05_PHEN'         : ['v22______diff_eta__00_05_PHENIX_dAu_________', None, None],
    ...
    #
    # #"dET_int_AuAu_PHEN"              : ['dETdeta__int__cent_______PHENIX_AuAu________', None, None],
    # #"dET_int_dAu_PHEN"               : ['dETdeta__int__cent_______PHENIX_dAu_________', None, None],
    #
    "meanpT_pi_STAR"                : ['mnpt_pi__int__cent_______STAR___AuAu________', 0, 8],
    #"meanpT_pi_PHEN"                : ['mnpt_pi__int__cent_______PHENIX_AuAu________', 0, 9],
    "meanpT_k_STAR"                 : ['mnpt_k___int__cent_______STAR___AuAu________', 0, 8],
    "meanpT_k_PHEN"                 : ['mnpt_k___int__cent_______PHENIX_AuAu________', 0, 9],
    #"meanpT_p_STAR"                 : ['mnpt_p___int__cent_______STAR___AuAu________', 0, 8],
    "meanpT_p_PHEN"                 : ['mnpt_p___int__cent_______PHENIX_AuAu________', 0, 9],
}
